...
public final class TemplateUtils {
	 ...
	 * spaces ({@code &#160;}) so the HTML/PDF renderer cannot break the line there. Uses
	 * the numeric character reference {@code &#160;} rather than the named entity
	 * {@code &nbsp;} because OpenHTMLtoPDF parses HTML as XHTML/XML, in which named HTML
	 * entities are not declared without an explicit DOCTYPE.
	 */
