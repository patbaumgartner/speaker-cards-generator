 ...
 *
 * <p>
 * Verifies that the application context starts up without errors using an in-memory H2
 * database (no PostgreSQL required for tests).
 */
@SpringBootTest
@TestPropertySource(properties = { "spring.datasource.url=jdbc:h2:mem:testdb;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
