 ...
 *
 * <p>Speakers are imported either via the Sessionize XLSX export ({@code /api/import/csv}) or
 * directly from the Devoxx CFP API ({@code /api/import/devoxx}).
 */
@Entity
public class Speaker implements Comparable<Speaker> {
  ...
  @URL public String companyURL;

  @URL public String blogURL;
  ...
  /**
   * External CFP system identifier used during import. Retained for reference; no longer used for
   * lookups.
   */
  ...
  /**
   * Returns a newline-separated string with all talk titles formatted for use in a Twitter/X post.
   *
