 ...
 *
 * <p>Bound from the {@code app.devoxx.*} namespace. The API base URL and event
 * identifier are used by {@link com.fortytwotalents.service.DevoxxImportService}
 * to fetch speakers directly from the Devoxx mobile API.
 *
 * <p>Example:
 * <pre>
...
public class DevoxxApiConfig {
     ...
     * {@code vdt26} (Voxxed Days Ticino 2026), or {@code vdcern26} (Voxxed Days CERN 2026).
     */
