 ...
 *
 * <p>Register as a Spring bean so {@link com.fortytwotalents.controller.BannerController} can
...
public final class TemplateUtils {
  ...
  /**
   * Removes the seconds component from a time string, returning only {@code HH:mm}. For example
   * {@code "11:00:00"} → {@code "11:00"}.
   *
  ...
  /**
   * Adds one hour to a time string and returns the result in {@code HH:mm} format. The hour wraps
   * around at 24. For example {@code "14:00:00"} → {@code "15:00"}.
   *
   * @param time time string; may be {@code null} or empty
  ...
  /**
   * Formats a date string from the stored {@code yyyy-MM-dd} representation into a human-readable
   * form such as {@code "January, 22nd, 2026"}.
   *
